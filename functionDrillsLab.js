...
function faveColorFinder(color){
  if (color === "Red"){
    return "Red is a great color little boy"
    } else if (color === "Green") {
      return "Green is a solid favorite color for girls"
    } else if (color === "Black"){
      return "So tendy my peeeeeeeps"
    } else {
      return "You need to evalute your life desitions for being a weird person"
    }
  }
...
var currentContestants = theEliminator(contestants, loser)
...
let veifiyCheck = emailCheck("kentharris13@gmail.com")
console.log(veifiyCheck)
...
//CODE HERE
function chocolateFrogMan(gold){
  if (gold % 3 === 0){
   return gold / 3
} else if  
  (gold % 3 === 1){
...
let totalFrogs = chocolateFrogMan(98)
...
let totalFrogs2 = chocolateFrogMan(4)
